...
export function getSampleProjects(): Project[] {
  return [
    ...
    },
    {
      ...
      description:
        "아이마켓코리아 EV충전 사업 양수도 — Proxy 연동(1단계 아이마켓/2단계 GS차지비) + GS-OCPP 직접연동 전환. 계약서 검토·전환 동의로 일정 변경: 7월 일부 상면 우선 전환, 8월 이후 순차, 시그넷·EVSIS 모델 ~12월.",
      status: "in_progress",
...
function imkTasks(): Task[] {
  return [
    ...
    {
      id: "imk-06",
      title: "MID 일괄 이관 방식(IC결제 인증 Block) 테스트",
      status: "in_progress",
      priority: "high",
      category: "tech_support",
      phase: 2,
      projectId: "biz-imk",
      assigneeOrPartner: "스마트로, 모니트",
      description:
        "이관 후 전체 충전기 전환 완료 시점까지 GS차지비 서버 접속 충전기의 IC 결제 인증을 Block → 이후 한 번에 MID 이관. 가능 여부 테스트.",
      nextAction: "이브이시스 7/1 · 시그넷 7/3(모니트) 테스트 후 확인",
      memo: "MID 이관 타이밍 리스크 관리(260630 업데이트). 스마트로 테스트 MID 환경 사용.",
      dueDate: "2026-07-03",
    ...
    },
    {
      ...
      description: "IMK 양수도 계약서 검토 및 상면 전환 동의 확보.",
      memo: "기존 5/31 전환 완료 예정이었으나 계약서 검토·전환 동의 확보로 일정 변경 → 7월 일부 전환, 8월 순차. 전환 일정 전반에 영향.",
      relatedLink: "https://app.notion.com/p/33cd87bed1fd8027b038f1b50952913d",
      createdAt: iso("2026-04-27"),
      updatedAt: iso("2026-07-02"),
    },
    {
    ...
    },
    {
      ...
      assigneeOrPartner: "모니트",
      description:
        "OCPP 1.6(BootNotification/StatusNotification/Start·StopTransaction/MeterValues 등) + DT(ServerAuth·icpayreport·GetChargeAmount) 전문 확인.",
    ...
    {
      id: "imk-10",
      title: "[Proxy 1단계] 아이마켓코리아 연동 Proxy 개발",
      status: "done",
      priority: "normal",
      category: "tech_support",
      phase: 3,
      projectId: "biz-imk",
      assigneeOrPartner: "모니트, 아이마켓코리아",
      description: "아이마켓코리아–모니트 간 Proxy 연동 개발.",
      memo: "6/5 Proxy 연동 개발 완료.",
      createdAt: iso("2026-05-20"),
      updatedAt: iso("2026-06-05"),
      completedAt: iso("2026-06-05"),
    },
    {
      id: "imk-11",
      title: "[Proxy 2단계] GS차지비 연동 Proxy 개발",
      status: "in_progress",
      priority: "high",
      category: "tech_support",
      phase: 3,
      projectId: "biz-imk",
      assigneeOrPartner: "모니트, GS차지비",
      description: "GS차지비 연동 Proxy 개발 및 모니트 측 프록시 테스트.",
      nextAction: "모니트 개발 지연 → 7/6까지 프록시 테스트 결과 회신 예정",
      memo: "6/10 개발 시작, 6/16 테스트 시작. 모니트 개발 지연으로 일정 지연.",
    ...
    {
      id: "imk-12",
      title: "[검증] JS테크 완속 IMK-EV7 GS-OCPP 직접연동 (713기)",
      status: "in_progress",
      priority: "high",
      category: "tech_support",
      phase: 4,
      projectId: "biz-imk",
      assigneeOrPartner: "JS테크, 모니트",
      chargerModel: "IMK-EV7",
      description: "Proxy 미적용 직접 연동 모델. 713기 대상 GS-OCPP 연동 검증.",
      nextAction: "IMK-EV7 수정 펌웨어 릴리즈 7/3(금) 오전 → 릴리즈 후 GS-OCPP 검증",
      memo: "6/24 시료 전달 완료. IMK-EV7 수정 펌웨어 릴리즈 7/3(금) 오전 예정(모니트 추가 개발).",
      startDate: "2026-06-25",
      dueDate: "2026-07-17",
      createdAt: iso("2026-06-19"),
      updatedAt: iso("2026-07-02"),
    },
    {
      id: "imk-13",
      title: "[검증] 대유플러스 완속 DY1007-11R GS-OCPP 직접연동 (483기)",
      status: "new",
      priority: "high",
      category: "tech_support",
      phase: 4,
      projectId: "biz-imk",
      assigneeOrPartner: "대유플러스, 모니트",
      chargerModel: "DY1007-11R",
      description: "Proxy 미적용 직접 연동 모델. 483기 대상 GS-OCPP 연동 검증.",
      nextAction: "대유플러스 시료 전달 7/9(목) 오후 → 수령 후 GS-OCPP 검증 착수",
      memo: "시료 전달 7/9(목) 오후 예정(6/19→6/30→7/9 지연). Proxy 테스트 우선으로 지연.",
    ...
    {
      id: "imk-14",
      title: "[개발] 시그넷 완속 HB14K-EV-C1C1-G1 (Proxy 선적용, 142기)",
      status: "new",
      priority: "normal",
      category: "tech_support",
      phase: 3,
      projectId: "biz-imk",
      assigneeOrPartner: "SK시그넷, 모니트",
      chargerModel: "HB14K-EV-C1C1-G1",
      description: "Proxy 선적용 후 GS-OCPP 연동 모델. 142기.",
      nextAction: "시그넷 프록시 TestCase 문서 회신 7/7(화) 예정",
      memo: "프록시 TestCase 문서 회신 7/7(화) 예정. ~12월 개발·현장 적용.",
      dueDate: "2026-12-31",
    ...
    {
      id: "imk-15",
      title: "[개발] EVSIS 완/급속 9모델 (Proxy 선적용, 498기)",
      status: "new",
      priority: "normal",
      category: "tech_support",
      phase: 3,
      ...
      assigneeOrPartner: "이브이시스",
      description:
        "Proxy 선적용 후 GS-OCPP 연동 EVSIS 9모델(JC-92B1-7-01B 등). UI 전달 6/15~7/31.",
      nextAction: "이브이시스 프록시 TestCase 문서 회신 7/2(목) 예정",
      memo: "프록시 TestCase 문서 회신 7/2(목) 예정. ~12월 개발·현장 적용. 기존 필드이슈 동일 모델(487기)에도 펌웨어 적용 가능.",
      dueDate: "2026-12-31",
      createdAt: iso("2026-07-02"),
      updatedAt: iso("2026-07-02"),
    },
    {
      id: "imk-16",
      title: "[검증] GS차지비 Proxy 검증 (삼성전자DS 평택 2단지 16기 선전환)",
      status: "new",
      priority: "high",
      category: "tech_support",
      phase: 4,
      projectId: "biz-imk",
      assigneeOrPartner: "GS차지비, 모니트, 삼성전자DS",
      description:
        "GS차지비 Proxy 연동 검증. 삼성전자DS 평택 2단지 주차동 16기(미운영 예정) 테스트 후 선전환.",
      memo: "6/30~ 검증 예정이었으나 모니트 개발 지연으로 ~7/10 지연.",
      startDate: "2026-06-30",
      dueDate: "2026-07-10",
      createdAt: iso("2026-06-16"),
      updatedAt: iso("2026-07-02"),
    },
    {
      id: "imk-17",
      title: "[전환 1단계] 아이마켓 운영 충전기 Proxy 서버 전환",
      status: "in_progress",
      priority: "normal",
      category: "tech_support",
      phase: 5,
      projectId: "biz-imk",
      assigneeOrPartner: "모니트, 아이마켓코리아",
      description: "아이마켓코리아 운영 충전기의 서버 접속을 Proxy로 전환(아이마켓 주소).",
      memo: "6/9 현장 연동 테스트, 6/10부터 전환 시작, 6/30까지 완료 예정.",
      startDate: "2026-06-10",
      dueDate: "2026-06-30",
    ...
    {
      id: "imk-18",
      title: "[전환 2단계] 7월 일부 상면 우선 전환",
      status: "in_progress",
      priority: "high",
      category: "tech_support",
      phase: 5,
      projectId: "biz-imk",
      assigneeOrPartner: "GS차지비, 모니트",
      description: "이관 동의 확보된 일부 상면을 GS차지비로 우선 전환.",
      memo: "계약서 검토·전환 동의 일정으로 5/31→변경. 7월 일부 상면 우선 전환.",
    ...
    {
      id: "imk-19",
      title: "[전환 3단계] 8월 이후 그 외 상면 순차 전환",
      status: "new",
      priority: "normal",
      category: "tech_support",
      phase: 5,
      projectId: "biz-imk",
      assigneeOrPartner: "GS차지비",
      description: "7월 우선 전환 외 나머지 상면을 8월 이후 순차 전환.",
      memo: "8월 이후 순차 전환 예정.",
    ...
    {
      id: "imk-20",
      title: "Proxy 계속 사용 대상 관리 (시그넷 급속 100/300kW 11기)",
      status: "new",
      priority: "low",
      category: "tech_support",
      phase: 5,
      projectId: "biz-imk",
      assigneeOrPartner: "SK시그넷",
      description: "펌웨어 수정 불가로 Proxy를 계속 사용해야 하는 대상 관리.",
      memo: "시그넷 급속 100kW/300kW 11기. 2021~2022 설치, 운영 약 5년.",
      createdAt: iso("2026-07-02"),
      updatedAt: iso("2026-07-02"),
    },
  ];
