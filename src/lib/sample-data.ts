...
function imkTasks(): Task[] {
  return [
    ...
    },
    {
      ...
      memo: "6/24 시료 전달 완료(6/12→6/19 지연). 펌웨어 수정 필요하여 모니트 추가 개발 중.",
    ...
    },
    {
      ...
      memo: "6/30 시료 전달 예정(6/19에서 지연). Proxy 테스트 우선이라 추가 지연 가능.",
    ...
    },
    {
      ...
      memo: "~12월 개발·현장 적용 예정. 기존 운영중 필드이슈 동일 모델(487기)에도 펌웨어 적용 가능.",
      dueDate: "2026-12-31",
      createdAt: iso("2026-07-02"),
      updatedAt: iso("2026-07-02"),
    },
